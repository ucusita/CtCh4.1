////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////  STATUS_ADS 3.0.8: VERSION DE ACTUALIZACION DE TAXI CADA 3 SEGUNDOS
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
var UsaPayPerUse;
var UltimaCarreraConSaldo='No';
var vip;
var saldo;
var cpc;
...
var RetardoPush=1000;
var temporizador;
//var RetardoActualizaPosicion=30000;  //Tiempo normal de actualizacion de posicion Taxi - CAMBIA A:
var RetardoActualizaPosicion=5000;  // ****    3 SEGUNDOS    ***
...
function InicializaGPS1vez()
  {
          ...
          empresa_madre= decodeURI(getUrlVars()["empresa"]) ;
          
          UsaPayPerUse=getUrlVars()["PayPerUse"];
          vip=getUrlVars()["vip"];
          saldo=getUrlVars()["saldo"];
          cpc=getUrlVars()["cpc"];
...
function scrAceptaViaje(){                    
          ...
          //Descontarle de su saldo el servicio recibido
          //enviar: DatosServicio.placa, DatosServicio.servicio_numero, cpc
          //alert("PayperUse:" + UsaPayPerUse + " / vip:" + vip + " saldo:" + saldo + " / cpc:" + cpc + " placa:" + DatosServicio.placa + "Servicio:" + DatosServicio.servicio_numero);
          if (UsaPayPerUse=='Si' && vip=='No') {               
              //var carreras = parseInt(saldo / cpc);
              //NotificaToast("Le quedan " + saldo + " carreras");

              var placa = DatosServicio.placa;
              var servnro = DatosServicio.servicio_numero;

              //var placa = 'Uno';        // Para testing directo usando consola
              //var servnro = '1111';

              // Verificar si le queda saldo para una nueva carrera
              //saldo = saldo - cpc;  //Calculo temporal
              if (Number(saldo) >= Number(cpc)) {
                  //Le puede asignar la carrera
                  //alert("placa:" + placa + " / monto:" + cpc + " servicio:" + servnro);
                  $.post(urllocal + 'tools/Tx_DescSaldo.php', 
                        {
                            placa : placa,
                            monto : cpc,
                            servicio : servnro,
                        ...
                        function(data){                               
                            ...
                            if (DatoRecibido.Resultado=="Ok")
                                {
                                      console.log("Actualización de saldo = Ok");
                                      // Todo Ok, continuar normalmente y actualiza el saldo
                                      saldo=DatoRecibido.saldo;
                                      var carreras = parseInt(saldo / cpc);
                                      //alert("Carreras: " + carreras);
                                      if (carreras==0) {
                                          console.log("ULTIMA CARRERA CON SALDO");
                                          NotificaToast("ULTIMA CARRERA CON SALDO");
                                          UltimaCarreraConSaldo='Si';
                                        }else{
                                          console.log("Le quedan " + carreras + " carreras");
                                          NotificaToast("Le quedan " + carreras + " carreras");
                                        };
                                }else{
                                  setTimeout(function(){
                                        ChangeStatus(Placa, "Inactivo");
                                    }, 2000)
                                  alert('No tiene comunicación con la central. Verifique su señal');
                    ...
                    .fail(function() 
                      {
                        ...
                        alert('No tiene comunicación con la central');
                        //Cerrar la aplicación
                        navigator.app.exitApp();
                      })
              }else{
                  ...
                  alert("Su saldo no le permite recibir carreras, por favor recargue...");
                  navigator.app.exitApp();
              };
          };
          //else { ...  Es un chofer de la empresa o la empresa no implementa PayPerUse
          ProcesarMsgTaxi();
...
function Estado_Libre(){
          ...
          //Si no VIP y se quedó sin saldo, termina la app
          if (UsaPayPerUse=='Si' && vip=='No' && UltimaCarreraConSaldo=='Si') 
            {
              setTimeout(function(){
                                        ChangeStatus(Placa, "Inactivo");
                                    }, 2000)
              alert("Por favor recargue saldo para continuar");
              navigator.app.exitApp();
            }; 
